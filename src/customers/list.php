...
<main>
    <section class="card">
        ...
        <?php if ($errorMessage !== null): ?>
            <p><strong>Ошибка:</strong> <?= htmlspecialchars($errorMessage, ENT_QUOTES, 'UTF-8') ?></p>
                    ...
                    <?php foreach ($customers as $customer): ?>
                        <tr>
                            ...
                            <td>
                                ...
                                |
                                <a href="<?= htmlspecialchars(base_url('customers/delete.php?id=' . (int)$customer['customer_id']), ENT_QUOTES, 'UTF-8') ?>"
